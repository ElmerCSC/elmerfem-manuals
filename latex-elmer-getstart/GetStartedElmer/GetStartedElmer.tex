...
Go to the following page for the Elmer project on Sourceforge:\\
 ...
 \url{https://sourceforge.net/projects/elmerfem/}\\

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{sf-files-0}
\caption{Elmer on Sourceforge}\label{fg:sf-files-0}
\end{figure}

See Figure~\ref{fg:sf-files-0}.  Click on the green \texttt{Download} button, which will start the download of the Windows installer for Elmer, with ElmerGUI, without mpi, 64 bits.\\

\newpage

\subsection*{Download Elmer - nightly}

To download the most recent nightly build of Elmer, go to the following page:\\

\url{https://www.nic.funet.fi/pub/sci/physics/elmer/}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{elmer}
\caption{Elmer Bin Windows}\label{fg:elmer}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{elmer-bin-win}
\caption{Elmer Bin Windows}\label{fg:elmer-bin-win}
\end{figure}

Once on that page, click on `bin' and then `windows', and select the file with the most recent date, that should be the nightly build.  Pick the file with .exe extension, and that will be an installer for Windows.\\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{elmer}
\caption{Elmer Doc}\label{fg:elmer-doc}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{elmer-doc}
\caption{Elmer Doc}\label{fg:elmer-doc-2}
\end{figure}


Download the individual files to get the most recent build of the manuals.  Also be sure to download the file, `tutorials-GUI-files.zip', because this folder contains working examples of ElmerGUI projects, one for each tutorial.
