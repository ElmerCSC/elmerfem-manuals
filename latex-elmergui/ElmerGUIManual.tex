...
\hypersetup{
    ...
    pdftitle={ElmerGUI Manual},    % title
...
\title{\Huge{\bf ElmerGUI Manual}}
\author{Mikko Lyly and Saeki Takayuki}
%\author{Mikko Lyly and Saeki}
%\\ 
...
% if it is desired to show `Bibliography' as an entry in the Table Of Contents
